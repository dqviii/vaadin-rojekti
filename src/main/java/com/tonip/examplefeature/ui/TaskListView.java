package com.tonip.examplefeature.ui;

import com.tonip.base.ui.ViewTitle;
import com.tonip.examplefeature.Task;
import com.tonip.examplefeature.TaskService;
...
@Route(value = "tasks")
@PageTitle("Task List")
@Menu(order = 10, icon = "icons/clipboard-check.svg", title = "Task List")
@PermitAll
